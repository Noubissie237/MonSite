...
<html>
		<head>
			...
			<meta charset = "utf-8" />
			<link rel = "stylesheet" href = "acceuil_inscription_corresPass.css" />
		</head>
	<body>
	...
	<div id = "block">
			...
			<h1>Creer votre compte de visiteurs</h1>
					...
					<p>Email<span> *</span><br/>
						<input type = "email" required name = "email" class = "input" placeholder = "	Votremail@gmail.com" class = "input" pattern = "^(.*)gmail.com$" value = "<?php if(isset($_POST['emal'])){ echo $_POST['email']; } ?>" /></p>
					...
					<p>Confirmer<span> *</span><br/>
						<input type = "password" name = "pass2" placeholder = "	Retapez le mot de passe" class = "input" required /><br/>
						<span>Mots de passes incohérents !</span></p>
					<p>Sexe:<span> *</span>
